...
urlpatterns = patterns('',
    ...
    url(r'^reportedespacho/(?P<despacho_id>\d+)', 'despacho.views.reportedespacho', name='reportedespacho'),
    url(r'^bruto/(?P<arrime_id>\d+)', 'arrime.views.bruto', name='bruto'),
    url(r'^tara/(?P<arrime_id>\d+)', 'arrime.views.tara', name='tara'),
    url(r'^despachobruto/(?P<despacho_id>\d+)', 'despacho.views.bruto', name='despachobruto'),
    url(r'^despachotara/(?P<despacho_id>\d+)', 'despacho.views.tara', name='despachotara'),
